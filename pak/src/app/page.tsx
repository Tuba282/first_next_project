  ...
  return (
    <main className="main h-dvh bg-fixed from-white" >
      ...
      <div className="hero max-w-screen-md mt-48">
        ...
        <p className="p1 text-xl pl-24 mt-8">The worlds largest deep sea port, Gwadar, is in Pakistan. Worlds highest paved road, the eighth wonder of the world (the China-Pakistan friendship highway or the Karakoram Highway) is in Pakistan! Pakistans Edhi Foundation proudly runs the worlds largest volunteer ambulance service.</p>
      </div>
